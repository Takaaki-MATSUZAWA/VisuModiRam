...
use egui::Color32;
fn led_ui(ui: &mut egui::Ui, on: bool, on_color: Color32) -> egui::Response {
...
pub fn led(on: bool, on_color: Color32) -> impl egui::Widget + 'static {
    move |ui: &mut egui::Ui| led_ui(ui, on, on_color)
}
// ----------------------------------------------------------------------------
